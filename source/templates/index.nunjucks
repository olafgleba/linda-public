...
<head>
  <meta charset="utf-8">
  <title><?php echo ($page->seo_meta_title) ? $page->seo_meta_title : $page->title ?> <?php echo ($page->seo_meta_sitename) ? "| ".$page->seo_meta_sitename : "| ".$config_seo_meta_sitename ?></title>
  <meta http-equiv="X-UA-Compatible" content="IE=Edge">
  <meta name="robots" content="<?php echo ($page->seo_meta_robots) ? $page->seo_meta_robots : $config_seo_meta_robots; ?>" />
  <meta name="description" content="<?php echo ($page->seo_meta_description) ? $page->seo_meta_description : $config_seo_meta_description; ?>" />
...
<body>
  ...
  <div class="page">
    ...
    <main role="main" class="page-content">
      ...
      <?php
      if ($page->layout) {
        include_once("./markup/layouts/{$page->layout}.php");
      } else {
        include_once("./markup/layouts/default.php");
      }
      ?>
  ...
  <script src="<?php echo $config->urls->templates?>assets/libs/vendor/jquery.min.js"></script>
